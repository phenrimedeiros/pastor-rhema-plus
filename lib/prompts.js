...
- Reflection questions must provoke honest self-examination`,
  ...
  exegesis: (input) => `You are a biblical scholar and exegesis expert for pastors. Extract key words in their original languages from the selected biblical text.

INPUTS:
- Reference: ${input.reference}
- Selected Text: ${input.selectedText}
- Testament: ${input.testament} (OT is Hebrew/Aramaic, NT is Greek)
- Language for Explanations: ${input.language}

Provide a detailed exegesis of the key words/terms in their original biblical language (Greek for NT, Hebrew/Aramaic for OT) that are essential to understanding this passage.

RESPOND ONLY IN VALID JSON (no markdown, no backticks, no preamble). Use this exact shape:
{
  ...
  "words": [
    {
      ...
      "phonetics": "lah-gahs",
      "strongs": "G3056",
      "parsing": "Noun, Masculine, Singular",
      "meaning": "Word, statement, speech, divine expression",
      "theologicalImpact": "Explanation of how this word impacts the meaning of the passage in the pastor's selected language"
    }
  ],
  "exegesisSynthesis": "A brief pastoral exegesis synthesis of the selected passage, showing how the original terms work together to deepen theological understanding (3-4 sentences)."
}

RULES:
- Extract 2 to 4 key words that are theologically significant in the passage.
- Ensure the original Greek or Hebrew script is correct.
- Provide clear transliteration and phonetic spelling.
- Provide the standard Strong's Concordance numbering (prefixed with G for Greek, H for Hebrew).
- The explanation of theologicalImpact and exegesisSynthesis must be written in the requested language: ${input.language}.
- Ground everything in actual biblical etymology. Do not fabricate root meanings.`,
};
